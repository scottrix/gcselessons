#!/usr/bin/env python3
"""Generate enhanced detailed lesson pages for self-teaching/parent-teaching."""
...
SUBJECT_CONFIGS = {
    "biology": {"name": "Biology", "emoji": "🧬", "nav": "biology", "boards": "AQA, Edexcel, OCR, CCEA", "tier": "Foundation and Higher", "lessons_per_topic": 5},
    "chemistry": {"name": "Chemistry", "emoji": "⚗️", "nav": "chemistry", "boards": "AQA, Edexcel, OCR, CCEA", "tier": "Foundation and Higher", "lessons_per_topic": 5},
    "physics": {"name": "Physics", "emoji": "⚡", "nav": "physics", "boards": "AQA, Edexcel, OCR, CCEA", "tier": "Foundation and Higher", "lessons_per_topic": 5},
    "mathematics": {"name": "Mathematics", "emoji": "📐", "nav": "mathematics", "boards": "AQA, Edexcel, OCR, Eduqas, CCEA", "tier": "Foundation and Higher", "lessons_per_topic": 4},
    "english-language": {"name": "English Language", "emoji": "📝", "nav": "english-language", "boards": "AQA, Edexcel, OCR, Eduqas, CCEA", "tier": "Foundation and Higher", "lessons_per_topic": 4},
    "english-literature": {"name": "English Literature", "emoji": "📚", "nav": "english-literature", "boards": "AQA, Edexcel, OCR, Eduqas, CCEA", "tier": "Foundation and Higher", "lessons_per_topic": 4},
}

DEFAULT_CONFIG = {"lessons_per_topic": 4, "tier": "Foundation and Higher", "boards": "AQA, Edexcel, OCR, Eduqas, CCEA", "nav": "", "name": "", "emoji": "📖"}
